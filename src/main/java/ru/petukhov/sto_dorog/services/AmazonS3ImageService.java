...
import ru.petukhov.sto_dorog.repositories.AmazonImageRepository;
import ru.petukhov.sto_dorog.util.FileUtils;
...
public class AmazonS3ImageService extends AmazonClientService{
    ...
    public AmazonS3ImageService(AmazonImageRepository amazonImageRepository) {
    ...
    public AmazonImage uploadImageToAmazon(MultipartFile multipartFile) {
        ...
        if (!validExtensions.contains(extension)) {
            ...
            throw new ValidationException((Throwable) validExtensions);
        } else {
    ...
    @SneakyThrows
    private String uploadMultipartFile(MultipartFile multipartFile) throws ConversionFailedException {
        String fileUrl;
